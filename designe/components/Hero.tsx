  ...
  return (
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          {/* Main Card */}
          <div className="glass-panel rounded-3xl p-6 border-primary/20 relative z-10 box-glow bg-[#0A0A0A]/80 transform rotate-y-6 hover:rotate-y-0 transition-transform duration-700 ease-out">
             {/* Header */}
          ...
          <div className="absolute -top-6 -right-6 w-full h-full glass-panel rounded-3xl bg-surface/30 opacity-40 -z-10 scale-95 border-white/5" />
          <div className="absolute -top-12 -right-12 w-full h-full glass-panel rounded-3xl bg-surface/10 opacity-20 -z-20 scale-90 border-white/5" />
        </motion.div>
      </div>
    </section>
  );
