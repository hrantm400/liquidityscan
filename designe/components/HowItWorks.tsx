            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  {/* Step Number Badge */}
                  <div className="absolute top-20 right-1/2 translate-x-10 -translate-y-2 bg-surface border border-white/10 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold font-mono text-gray-400 group-hover:text-primary group-hover:border-primary transition-colors z-20">
                    0{idx + 1}
                  </div>
